    ...
    public String extractTag(String sentence) {
        ...
        for (Tree substree : treeArr) {
            ...
            if(substree.label().toString().equals(",")){
                ...
                + "    <description>Comma splice: This is using a comma to join two independent clauses. For example, 'I run a full mile today, I am tired.' The clause 'I run a full mile today' can stand on its own as a complete sentence. </description>\n"
                + "    <precontext></precontext>\n"
                + "    <suggestions>\n"
                + "        <option>or, and, but, so, yet</option>\n" 
                + "    </suggestions>\n"
                + "    <type>grammar</type>\n"
                + "\n"
                + "  </error>\n"
