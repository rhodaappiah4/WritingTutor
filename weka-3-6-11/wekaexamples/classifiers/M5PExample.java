...
public class M5PExample {
  public final static String FILENAME = "/Users/Rhoda/Desktop/WritingTutor/output.txt";

  public final static String URL = "jdbc:mysql://localhost:3306/writingTutor";
  ...
  public void train() throws Exception {
    ...
    query.setQuery("select * from sentences");
  ...
  public void predict() throws Exception {
    ...
    query.setUsername(USER);
    query.setPassword(PASSWORD);
    query.setQuery("select * from sentences");  // retrieves the same table only for simplicty reasons.
    Instances data = query.retrieveInstances();
